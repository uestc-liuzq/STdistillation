...
def main(args):
    ...
    optimizer_ts = torch.optim.Adam(net_eval.parameters(), lr=args.lr_ts)
    optimizer_lr = torch.optim.Adam(net_eval.parameters(), lr=args.lr_ts)
    ...
    for it in range(0, args.Iteration + 1):
        ...
        if it in eval_it_pool:  net_eval,_ = train_synset(args, net_eval,optimizer_lr, criterion, train_loader, test_loader, it)
