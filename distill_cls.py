...
from process.data_loader_cls import get_data
from process.exp_cls import evaluate_synset
from process.exp import TensorDataset
from utils import get_dataset, get_network, get_eval_pool, get_time, add_noise
import wandb
import copy
import random
    ...
    for it in range(0, args.Iteration+1):
        ...
        if it in eval_it_pool:
            for model_eval in model_eval_pool:
                ...
                _,_,acc_train,acc_test = evaluate_synset(net_eval, x_syn_eval,y_syn_eval, test_loader, args)
        ...
        student_net = ST_Model(args).to(args.device)  # get a random layers
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='PatchTST', help='layers id')
    parser.add_argument('--layers', type=str, default='TSFE',
                        help='layers name, options: [Autoformer, Informer, Transformer]')

    # data loader
    parser.add_argument('--data', type=str, default='custom', help='dataset type')
    parser.add_argument('--data_name', type=str, default='ElectricDevices')
    ...
    # forecasting task
    parser.add_argument('--seq_len', type=int, default=131, help='input sequence length')
    parser.add_argument('--label_len', type=int, default=48, help='start token length')
    parser.add_argument('--pred_len', type=int, default=96, help='prediction sequence length')

    # Dataset Description

    parser.add_argument('--dsid', type=str, default='FaceAll', help='Classification Dataset ID')
    parser.add_argument('--labels', type=int, required=True, default=37, help='TS labels')
